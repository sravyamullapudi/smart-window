...
@Component({
  selector: 'lib-smart-window-lib',
  templateUrl: './smart-window-lib.component.html',
  styleUrls: ['./smart-window-lib.component.scss'],
  animations: [
    trigger('animation', [
...
export class SmartWindowLibComponent implements AfterContentInit, OnInit, OnDestroy {
